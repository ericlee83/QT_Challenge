...
public class AirportRestController {
	...
	public AirportInfoResponse findAirportsByQuery(
		...
		AirportFilter filter = new AirportFilter.AirportFilterBuilder().hasAirportCode(airportCode)
				.fromCountryCode(countryCode).isInternationalAirport(internationalAirport)
				.isRegionalAirport(regionalAirport).build();
